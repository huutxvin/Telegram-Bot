...
class HelpCommand extends UserCommand
{
     ...
     * @var string
     */
    protected $description = 'Hiển thị danh sách các lệnh';
    ...
    public function execute()
    {
        ...
        if ($command_str === '') {
            $data['text'] = '*Danh sách Commands*:' . PHP_EOL;
            ...
            $data['text'] .= PHP_EOL . 'Để hiển thị chính xác command, gõ: /help <tên command>';
        ...
        $data['text'] = 'Command /' . $command_str . ' Không tồn tại';
